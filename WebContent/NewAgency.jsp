...
<title>Public Transit Open Data Edit Platform</title>
	...
	<script src="js/new.gtfs/agency.js"></script>
...
<body>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">New Agency</h3></header>
		<form id="form_new_agency">
					<fieldset style="margin-left: 1%; margin-right: 2%;">
						...
						<input id="new_agency_id" type="text" style="width:96%;" value="<%= agency_id%>" disabled>
					</fieldset>
					<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
						...
						<input id="new_agency_name" type="text" style="width:92%;" value="" placeholder="e.g. The Fun Bus" autofocus>
					</fieldset>
					<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Agency URL * <a href="javascript:show_detail_agency(&quot;agency_url&quot;)">(Read More)</a></label>
						<input id="new_agency_url" type="url" style="width:92%;" placeholder="e.g. http://www.thefunbus.org" value="">
					</fieldset>
					<fieldset style="width:48%; float:left; margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
						<label>Agency Timezone * <a href="javascript:show_detail_agency(&quot;agency_timezone&quot;)">(Read More)</a></label>
						<div style="margin-left:10px;">
						<select id="new_agency_timezone" data-placeholder="Choose a Timezone..." class="chose_timezone">
						<!-- timezones -->
					...
					<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
						...
						<div style="margin-left:10px;">
						<select id="new_agency_lang" data-placeholder="Choose a Language..." class="chose_language">
							<option value=""></option>
					...
					<fieldset style="width:48%; float:left; margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
						...
						<input id="new_agency_phone" type="text" style="width:92%;" placeholder="e.g. (310) 555-0222">
					</fieldset>
					<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
						<label>Agency Fare URL <a href="javascript:show_detail_agency(&quot;agency_fare_url&quot;)">(Read More)</a></label>
						<input id="new_agency_fare_url" type="text" style="width:92%;">
