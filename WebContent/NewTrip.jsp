...
<title>Public Transit Open Data Edit Platform</title>
	...
	<script src="js/new.gtfs/trip.js"></script>
...
<body>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">New Trip</h3>
		<ul class="tabs">
		...
		<div class="tab_container">
			<div id="new" class="tab_content" style="overflow:auto; height:500px">
						<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input id="new_trip_id" type="text" style="width:92%;" value="" placeholder="e.g. AWE1">
						</fieldset>
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Route ID * <a href="javascript:show_detail_trip(&quot;route_id&quot;)">(Read More)</a></label>
							<div style="margin-left:10px;">
							<select id="new_route_id" data-placeholder="Choose a Route ID..." class="choose_list">
					            <option value=""></option>
							</select>
							<script type="text/javascript">
							load_routes();
						...
						<fieldset style="width:48%; float:left; margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<div style="margin-left:10px;">
							<select id="new_service_id" data-placeholder="Choose a Service ID..." class="choose_list">
					            <option value=""></option>
							</select>
							<script type="text/javascript">
							load_calendar();
						...
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input id="new_trip_headsign" type="text" style="width:92%;" placeholder="e.g. Downtown">
						</fieldset>
						<fieldset style="width:48%; float:left; margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Trip Short Name <a href="javascript:show_detail_trip(&quot;trip_short_name&quot;)">(Read More)</a></label>
							<input id="new_trip_short_name" type="text" style="width:92%;">
						</fieldset>
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Direction ID <a href="javascript:show_detail_trip(&quot;direction_id&quot;)">(Read More)</a></label>
							<div style="margin-left:10px;">
							<select id="new_direction_id" data-placeholder="Choose a Direction ID..." class="choose_list">
					            <option value=""></option>
						...
						<fieldset style="width:48%; float:left; margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input id="new_block_id" type="text" style="width:92%;" placeholder="e.g. 1">
						</fieldset>
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Shape ID <a href="javascript:show_detail_trip(&quot;shape_id&quot;)">(Read More)</a></label>
							<input id="new_shape_id" type="text" style="width:92%;" disabled>
						</fieldset>
						<div class="clear"></div>
						<fieldset style="width:48%; float:left; margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>Wheelchair Accessible <a href="javascript:show_detail_trip(&quot;wheelchair_accessible&quot;)">(Read More)</a></label>
							<div style="margin-left:10px;">
							<select id="new_wheelchair_accessible" data-placeholder="Choose wheelchair accessibility..." class="choose_list">
					            <option value=""></option>
						...
						<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<div style="margin-left:10px;">
							<select id="new_bikes_allowed" data-placeholder="Bikes allowed..." class="choose_list">
					            <option value=""></option>
...
$("#new_route_id").on('change', function(evt, params) {
	if(params === undefined) {	//when user clears the selection (select nothing)
		$("#new_shape_id").val('');
		return;
	} else if(params.selected != "" && $("#new_service_id").val() != "")
    	$("#new_shape_id").val(params.selected + '##' + $("#new_service_id").val());
});
$("#new_service_id").on('change', function(evt, params) {
	if(params === undefined) {	//when user clears the selection (select nothing)
    	...
    	$("#new_shape_id").val($("#new_route_id").val() + '##' + params.selected);
});
</script>
</body>
