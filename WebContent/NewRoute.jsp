...
<title>Public Transit Open Data Edit Platform</title>
	...
	<script src="js/new.gtfs/route.js"></script>
...
<body>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">New Route</h3>
		<ul class="tabs">
		...
		<div class="tab_container">
			<div id="new" class="tab_content" style="overflow:auto; height:500px">
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<input type="text" id="new_route_id" style="width:92%;" value="" placeholder="e.g. A" onblur="existence_check()" autofocus>
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Agency ID <a href="javascript:show_detail_route(&quot;agency_id&quot;)">(Read More)</a></label>
					<input type="text" id="new_agency_id" style="width:92%;" value="<%= agency_id%>" disabled>
				</fieldset><div class="clear"></div>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Route Short Name * <a href="javascript:show_detail_route(&quot;route_short_name&quot;)">(Read More)</a></label>
					<input type="text" id="new_route_short_name" style="width:92%;" value="" placeholder="e.g. 17">
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Route Long Name * <a href="javascript:show_detail_route(&quot;route_long_name&quot;)">(Read More)</a></label>
					<input type="text" id="new_route_long_name" style="width:92%;" value="" placeholder="e.g. Mission">
				</fieldset><div class="clear"></div>
				<fieldset style="margin-left: 1%; margin-right: 2%;">
					...
					<textarea rows="3" id="new_route_desc" placeholder='e.g. The "A" route travels from lower Mission to Downtown.'></textarea>
				</fieldset>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Route Type * <a href="javascript:show_detail_route(&quot;route_type&quot;)">(Read More)</a></label>
					<div style="margin-left:10px;">
					<select id="new_route_type" data-placeholder="Choose a Route Type..." class="choose_route_type">
						<option value=""></option>
				...
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<input type="text" id="new_route_url" style="width:92%;" value="" placeholder="e.g. http://www.thefunbus.org">
				</fieldset><div class="clear"></div>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Route Color <a href="javascript:show_detail_route(&quot;route_color&quot;)">(Read More)</a></label>
					<input type="text" id="new_route_color" class="picker" style="width:92%;" value="" placeholder="e.g. FFFFFF" readonly>
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Route Text Color <a href="javascript:show_detail_route(&quot;route_text_color&quot;)">(Read More)</a></label>
					<input type="text" id="new_route_text_color" class="picker" style="width:92%;" value="" placeholder="e.g. 000000" readonly>
				</fieldset>
