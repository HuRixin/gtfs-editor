...
<title>Public Transit Open Data Edit Platform</title>
	...
	<script src="js/new.gtfs/stop.js"></script>
	...
	function change_to_tab_new(lat, lon) {
		$("ul.tabs li").removeClass("active"); //Remove any "active" class
		...
		if(is_new_saved == false)
			...
			alertify.confirm("Current modifications have not been saved, continue?", function (e) {
			    if (e) {
					...
					$("#new_stop_lon").val(lon);
					$("#new_stop_desc").val(current_marker_addr);
					is_new_saved = false;
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			...
			<div class="breadcrumb_divider"></div> <a class="current" href="NewAgency.jsp">Agency</a>
			<div class="breadcrumb_divider"></div> <a class="current" href="NewCalendar.jsp">Calendar</a>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">New Stop <a href="javascript:show_detail_stop(&quot;usage&quot;)">(Usage)</a></h3>
		<ul class="tabs">
		...
		<div class="tab_container">
			<div id="map" class="tab_content" style="overflow:auto; height:650px">
				<div id="map_new_stop" style="width:100%; height:100%"><script src="js/map/map.newstop.js"></script></div>
			</div>
			<div id="new" class="tab_content" style="overflow:auto; height:650px">
				<fieldset style="margin-left: 1%; margin-right: 2%;">
					<label>Stop ID * <a href="javascript:show_detail_stop(&quot;stop_id&quot;)">(Read More)</a></label>
					<input type="text" id="new_stop_id" onblur="existence_check()" placeholder="e.g. S1" autofocus>
				</fieldset>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<input type="text" id="new_stop_code" style="width:92%;" value="" placeholder="e.g. pv202">
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Stop Name * <a href="javascript:show_detail_stop(&quot;stop_name&quot;)">(Read More)</a></label>
					<input type="text" id="new_stop_name" style="width:92%;" value="" placeholder="e.g. Mission St. & Silver Ave.">
				</fieldset><div class="clear"></div>
				<fieldset style="margin-left: 1%; margin-right: 2%;">
					<label>Stop Description <a href="javascript:show_detail_stop(&quot;stop_desc&quot;)">(Read More)</a></label>
					<textarea rows="2" id="new_stop_desc" placeholder="e.g. The stop is located at the southwest corner of the intersection."></textarea>
				</fieldset>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Stop Latitude * <a href="javascript:show_detail_stop(&quot;stop_lat&quot;)">(Read More)</a></label>
					<input type="text" id="new_stop_lat" maxlength="10" class="validate_stop_latlon" style="width:92%;" value="" placeholder="e.g. 45.18601">
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Stop Longitude * <a href="javascript:show_detail_stop(&quot;stop_lon&quot;)">(Read More)</a></label>
					<input type="text" id="new_stop_lon" maxlength="10" class="validate_stop_latlon" style="width:92%;" value="" placeholder="e.g. 9.15466">
				</fieldset><div class="clear"></div>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Zone ID <a href="javascript:show_detail_stop(&quot;zone_id&quot;)">(Read More)</a></label>
					<input type="text" id="new_zone_id" style="width:92%;" value="">
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Stop Url <a href="javascript:show_detail_stop(&quot;stop_url&quot;)">(Read More)</a></label>
					<input type="text" id="new_stop_url" style="width:92%;" value="" placeholder="e.g. http://www.thefunbus.org">
				</fieldset><div class="clear"></div>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>Location Type <a href="javascript:show_detail_stop(&quot;location_type&quot;)">(Read More)</a></label>
					<div style="margin-left:10px;">
					<select id="new_location_type" data-placeholder="Choose a Location Type..." class="stop_options">
						<option value=""></option>
				...
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<div style="margin-left:10px;">
					<select id="new_parent_station" data-placeholder="Choose a Location Type..." class="stop_options">
						<option value=""></option>
						<option value="0">0 or blank - Stop</option>
						<option value="1">1 - Station</option>
					</select>
				...
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<div style="margin-left:10px;">
					<select id="new_stop_timezone" data-placeholder="Choose a Timezone..." class="stop_options">
					<!-- timezones -->
				...
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<div style="margin-left:10px;">
					<select id="new_wheelchair_boarding" data-placeholder="Choose a Location Type..." class="stop_options">
						<option value=""></option>
