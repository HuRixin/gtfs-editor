...
<title>Public Transit Open Data Edit Platform</title>
	...
	<script src="js/new.gtfs/calendar.js"></script>
...
<body>
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">New Calendar</h3>
		<ul class="tabs">
		...
		<div class="tab_container">
			<div id="new" class="tab_content" style="overflow:auto; height:400px">
				<fieldset style="margin-left: 1%; margin-right: 2%;">
					...
					<input type="text" id="new_service_id" name="new_service_id" placeholder="e.g. Weekday" onblur="existence_check()" autofocus>
				</fieldset>
				<fieldset style="width:48%; float:left;  margin-left: 1%; margin-right: 1%;"> <!-- to make two field float next to one another, adjust values accordingly -->
					...
					<input type="text" id="new_start_date" style="width:92%;" value="" placeholder="e.g. 20060701" readonly>
				</fieldset>
				<fieldset style="width:48%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
					<label>End Date * <a href="javascript:show_detail_calendar(&quot;end_date&quot;)">(Read More)</a></label>
					<input type="text" id="new_end_date" style="width:92%;" value="" placeholder="e.g. 20060731" readonly>
				</fieldset>
				<div class="clear"></div>
				...
				<tbody>
					<tr>
						<td>Available</td>
						<td><input name="Monday" type="radio" value="1"></td>
						<td><input name="Tuesday" type="radio" value="1"></td>
						<td><input name="Wednesday" type="radio" value="1"></td>
						<td><input name="Thursday" type="radio" value="1"></td>
						<td><input name="Friday" type="radio" value="1"></td>
						<td><input name="Saturday" type="radio" value="1"></td>
						<td><input name="Sunday" type="radio" value="1"></td>
					</tr>
					<tr>
						<td>Not Available</td>
						<td><input name="Monday" type="radio" value="0"></td>
						<td><input name="Tuesday" type="radio" value="0"></td>
						<td><input name="Wednesday" type="radio" value="0"></td>
						<td><input name="Thursday" type="radio" value="0"></td>
						<td><input name="Friday" type="radio" value="0"></td>
						<td><input name="Saturday" type="radio" value="0"></td>
						<td><input name="Sunday" type="radio" value="0"></td>
					</tr>
				</tbody>
				</table>
				<div class="clear"></div>
...
var agency_id = "<%=agency_id%>";
       $( '#new_start_date' ).pickadate({ format: 'yyyymmdd' });
       $( '#new_end_date' ).pickadate({ format: 'yyyymmdd' });
 </script>
</body>
